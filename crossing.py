...
class CrossingEnvNotGen(MiniGridEnv):
    """
    Environment with wall or lava obstacles, sparse reward.
    """
    ...
    def _gen_grid(self, width, height):
        ...
        # Place obstacles (lava or walls) in "U" form

        self.obstacle_type = Wall
        self.put_obj(self.obstacle_type(), 1, 4)
        ...
        self.put_obj(self.obstacle_type(), 7, 5)
        self.put_obj(self.obstacle_type(), 7, 6)
        '''
...
class SimpleCrossingEnvUmaze(CrossingEnvNotGen):
    def __init__(self):
        super().__init__(size=9, num_crossings=1)

register(
    id='MiniGrid-SimpleCrossingEnvUmaze-v0',
    entry_point='gym_minigrid.envs:SimpleCrossingEnvUmaze'
)